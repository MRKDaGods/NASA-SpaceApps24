...
namespace MRK {
	...
	[Serializable]
	[PostProcess(typeof(EGRBlurRenderer), PostProcessEvent.AfterStack, "EGR/Blur")]
	public sealed class EGRBlur : PostProcessEffectSettings {
		[Range(1, 16)]
	...
	public sealed class EGRBlurRenderer : PostProcessEffectRenderer<EGRBlur> {
		RenderTexture[] textures = new RenderTexture[16];
		PropertySheet sheet;

		public override void Render(PostProcessRenderContext context) {
			if (sheet == null)
				sheet = context.propertySheets.Get(Shader.Find("Hidden/EGR/Blur"));
